...
namespace RestSharp
{
    ...
    public partial class RestClient : IRestClient
    {
        ...
        {
            return await ExecuteGetTaskAsync<T>(request, CancellationToken.None);
        }
        ...
        public virtual async Task<IRestResponse<T>> ExecuteGetTaskAsync<T>(IRestRequest request, CancellationToken token)
        {
            ...
            return await ExecuteTaskAsync<T>(request, token);
        }
        ...
        {
            return await ExecutePostTaskAsync<T>(request, CancellationToken.None);
        }
        ...
        {
            return await ExecuteTaskAsync<T>(request, CancellationToken.None);
        }
        ...
        public virtual async Task<IRestResponse<T>> ExecuteTaskAsync<T>(IRestRequest request, CancellationToken token)
        {
            ...
            return Deserialize<T>(request, await ExecuteTaskAsync(request));
        }
        ...
        {
            return await ExecuteTaskAsync(request, CancellationToken.None);
        }
