...
public static partial class RestRequestExtensions {
    static partial class PropertyCache<T> where T : class {
        sealed partial class Populator {
            ...
            static void Populate(object @object, RequestProperty requestProperty, ICollection<Parameter> parameters) => Populate(GetStringValueKnown(@object), requestProperty, parameters);
            ...
            static string? GetStringValueUnknown(object @object, RequestProperty requestProperty) => @object switch {
