...
namespace RestSharp
{
 ...
 DynamicObject,
            ...
            IDictionary<string, object>
    {
        ...
        /// </summary>
        public JsonObject() => _members = new Dictionary<string, object>();
        ...
        ///     type of the key.
        /// </param>
        public JsonObject(IEqualityComparer<string> comparer) => _members = new Dictionary<string, object>(comparer);
        ...
        public void Add(string key, object value) => _members.Add(key, value);
        ...
        public void Add(KeyValuePair<string, object> item) => _members.Add(item.Key, item.Value);
...
namespace RestSharp
{
        ...
        static class SimpleJson
    {
                ...
                if (c == '\\')
                {
                    ...
                    else if (c == 'u')
                    {
                        ...
                        if (remainingLength >= 4)
                        {
                            ...
                            if (!(success = uint.TryParse(
                                new string(json, index, 4), NumberStyles.HexNumber, CultureInfo.InvariantCulture, out codePoint
                            )))
                                return "";
                            ...
                            if (0xD800 <= codePoint && codePoint <= 0xDBFF) // if high surrogate
                            {
                                ...
                                if (remainingLength >= 6)
                                {
                                    ...
                                    if (new string(json, index, 2) == "\\u" && uint.TryParse(
                                        new string(json, index + 2, 4), NumberStyles.HexNumber, CultureInfo.InvariantCulture, out lowCodePoint
                                    ))
        ...
        static bool SerializeString(string aString, StringBuilder builder)
        {
            ...
            if (safeCharacterCount > 0) builder.Append(charArray, charArray.Length - safeCharacterCount, safeCharacterCount);
 ...
 DataContractJsonSerializerStrategy
        ...
        class PocoJsonSerializerStrategy : IJsonSerializerStrategy
    {
        ...
        protected virtual string MapClrMemberNameToJsonFieldName(string clrPropertyName) => clrPropertyName;
        ...
        internal virtual IDictionary<string, KeyValuePair<Type, ReflectionUtils.SetDelegate>> SetterValueFactory(Type type)
        {
            ...
            foreach (var propertyInfo in ReflectionUtils.GetProperties(type))
                if (propertyInfo.CanWrite)
                {
                    ...
                    result[MapClrMemberNameToJsonFieldName(propertyInfo.Name)] = new KeyValuePair<Type, ReflectionUtils.SetDelegate>(
            ...
            foreach (var fieldInfo in ReflectionUtils.GetFields(type))
            {
                ...
                result[MapClrMemberNameToJsonFieldName(fieldInfo.Name)] = new KeyValuePair<Type, ReflectionUtils.SetDelegate>(
                ...
                if (str.Length != 0) // We know it can't be null now.
                {
                    if (type == typeof(DateTime) || ReflectionUtils.IsNullableType(type) && Nullable.GetUnderlyingType(type) == typeof(DateTime))
                        return DateTime.ParseExact(
                            str, Iso8601Format, CultureInfo.InvariantCulture, DateTimeStyles.AssumeUniversal | DateTimeStyles.AdjustToUniversal
                        );
    ...
    namespace Reflection
    {
            ...
            class ReflectionUtils
        {
            ...
            public static ConstructorDelegate GetConstructorByReflection(ConstructorInfo constructorInfo)
                => delegate(object[] args) { return constructorInfo.Invoke(args); };
            ...
            public static SetDelegate GetSetMethodByReflection(FieldInfo fieldInfo)
                => delegate(object source, object value) { fieldInfo.SetValue(source, value); };
