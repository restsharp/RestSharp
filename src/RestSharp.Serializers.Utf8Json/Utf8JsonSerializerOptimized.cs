...
{
    public class Utf8JsonSerializerOptimized : IRestSerializer
    {
        public Utf8JsonSerializerOptimized(IJsonFormatterResolver resolver = null) => Resolver = resolver ?? StandardResolver.AllowPrivateExcludeNullCamelCase;
