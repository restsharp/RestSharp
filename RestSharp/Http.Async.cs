...
namespace RestSharp
{
    ...
    public partial class Http
    {
        ...
        private void WriteRequestBodyAsync(HttpWebRequest webRequest, Action<HttpResponse> callback)
        {
            ...
            {
#if !WINDOWS_PHONE && !WINDOWS_UWP && !(NETCORE50 || NETSTANDARD1_5 || NETSTANDARD1_6)
...
#if !WINDOWS_PHONE && !SILVERLIGHT && !WINDOWS_UWP && !(NETCORE50 || NETSTANDARD1_5 || NETSTANDARD1_6)
...
#if !SILVERLIGHT && !WINDOWS_UWP && !(NETCORE50 || NETSTANDARD1_5 || NETSTANDARD1_6)
