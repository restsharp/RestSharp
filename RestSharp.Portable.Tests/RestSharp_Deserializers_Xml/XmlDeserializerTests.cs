...
{
    [Trait("Unit","XML Deserializer Tests")]
	public class XmlDeserializerTests
	{
        ...
        {
            var doc = CreateElementsXmlWithNamespace();
        ...
        {
            var doc = CreateAttributesXmlWithNamespace();
            var response = new RestResponse { Content = doc };
        ...
        [Fact]
        public void Ignore_Protected_Property_That_Exists_In_Data_With_Namespace()
        {
            var doc = CreateElementsXmlWithNamespace();
            var response = new RestResponse { Content = doc };
        ...
        [Fact]
        public void Ignore_ReadOnly_Property_That_Exists_In_Data_With_Namespace()
        {
            var doc = CreateElementsXmlWithNamespace();
            var response = new RestResponse { Content = doc };
        ...
        {
            var doc = CreateUnderscoresXmlWithNamespace();
            var response = new RestResponse { Content = doc };
        ...
        {
            var doc = CreateListOfPrimitivesXmlWithNamespace();
            var response = new RestResponse { Content = doc };
        ...
        private static string CreateListOfPrimitivesXmlWithNamespace()
        {
            var doc = new XDocument();
        ...
        private static string CreateUnderscoresXmlWithNamespace()
        {
            var doc = new XDocument();
            var ns = XNamespace.Get("http://restsharp.org");
        ...
        private static string CreateElementsXmlWithNamespace()
        {
            var doc = new XDocument();
            var ns = XNamespace.Get("http://restsharp.org");
            var root = new XElement(ns + "Person");
        ...
        private static string CreateAttributesXmlWithNamespace()
        {
            var doc = new XDocument();
            var ns = XNamespace.Get("http://restsharp.org");
            var root = new XElement(ns + "Person");
