    ...
    public class NuSpecUpdateTask
    {
        ...
        public class Execute
        {
            public class WhenSpecFileNotSpecified
            {
                ...
                {
                    var task = new RestSharp.Build.NuSpecUpdateTask();
            ...
            [Trait("Unit", "Nuspec Update Tests")]
            public class WhenSpecFileIsValid : BaseNuSpecUpdateTest
            {
                private RestSharp.Build.NuSpecUpdateTask _subject = new RestSharp.Build.NuSpecUpdateTask();
