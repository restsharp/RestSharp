...
public class RestClientTests {
    ...
    [Fact]
    public void BuildUri_should_build_with_passing_link_as_Uri_with_empty_BaseUrl() {
        // arrange
        var absolute = new Uri($"{BaseUrl}/foo/bar/baz");
        var req      = new RestRequest(absolute);
